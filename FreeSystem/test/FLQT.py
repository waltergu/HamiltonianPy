...
def test_flqt():
    ...
    a.register(EB(name='EB',path=BaseSpace(('t',linspace(0,1,100))),savedata=False,run=TBAEB))
    a.register(QEB(name='QEB',ts=TSpace(array([0,0.5,1])),savedata=False,run=FLQTQEB))
    a.summary()
    print
