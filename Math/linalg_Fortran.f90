subroutine fkron_csr_r4(d1,inds1,indp1,shp1,rs1,d2,inds2,indp2,shp2,rs2,nnz,d,inds,indp,shp,nd1,n1,nd2,n2,nr)
    implicit none
    ...
    integer,intent(in) :: rs1(nr),rs2(nr)
...
subroutine fkron_csr_r8(d1,inds1,indp1,shp1,rs1,d2,inds2,indp2,shp2,rs2,nnz,d,inds,indp,shp,nd1,n1,nd2,n2,nr)
    implicit none
    integer,intent(in) :: nnz,nd1,n1,nd2,n2,nr
...
subroutine fkron_csr_c4(d1,inds1,indp1,shp1,rs1,d2,inds2,indp2,shp2,rs2,nnz,d,inds,indp,shp,nd1,n1,nd2,n2,nr)
    implicit none
    integer,intent(in) :: nnz,nd1,n1,nd2,n2,nr
...
subroutine fkron_csr_c8(d1,inds1,indp1,shp1,rs1,d2,inds2,indp2,shp2,rs2,nnz,d,inds,indp,shp,nd1,n1,nd2,n2,nr)
    implicit none
    integer,intent(in) :: nnz,nd1,n1,nd2,n2,nr
...
subroutine fkron_csc_r4(d1,inds1,indp1,shp1,cs1,d2,inds2,indp2,shp2,cs2,nnz,d,inds,indp,shp,nd1,n1,nd2,n2,nc)
    implicit none
    ...
    integer,intent(in) :: indp1(n1),indp2(n2)
    integer,intent(in) :: shp1(2),shp2(2)
    integer,intent(in) :: cs1(nc),cs2(nc)
    real(4),intent(out) :: d(nnz)
    integer,intent(out) :: inds(nnz)
...
subroutine fkron_csc_r8(d1,inds1,indp1,shp1,cs1,d2,inds2,indp2,shp2,cs2,nnz,d,inds,indp,shp,nd1,n1,nd2,n2,nc)
    implicit none
    integer,intent(in) :: nnz,nd1,n1,nd2,n2,nc
    real(8),intent(in) :: d1(nd1),d2(nd2)
    integer,intent(in) :: inds1(nd1),inds2(nd2)
...
subroutine fkron_csc_c4(d1,inds1,indp1,shp1,cs1,d2,inds2,indp2,shp2,cs2,nnz,d,inds,indp,shp,nd1,n1,nd2,n2,nc)
    implicit none
    integer,intent(in) :: nnz,nd1,n1,nd2,n2,nc
    complex(4),intent(in) :: d1(nd1),d2(nd2)
    integer,intent(in) :: inds1(nd1),inds2(nd2)
...
subroutine fkron_csc_c8(d1,inds1,indp1,shp1,cs1,d2,inds2,indp2,shp2,cs2,nnz,d,inds,indp,shp,nd1,n1,nd2,n2,nc)
    implicit none
    integer,intent(in) :: nnz,nd1,n1,nd2,n2,nc
    complex(8),intent(in) :: d1(nd1),d2(nd2)
    integer,intent(in) :: inds1(nd1),inds2(nd2)
