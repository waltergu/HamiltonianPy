...
class TestSpin(TestCase):
    ...
    def test_indices(self):
        r1=[Index(pid=PID(scope='WG',site=0),iid=SID(orbital=ob,S=self.spin.S)) for ob in xrange(self.spin.norbital)]
        r2=[Index(pid=PID(scope='WG',site=None),iid=SID(orbital=ob,S=self.spin.S)) for ob in xrange(self.spin.norbital)]
