...
from HamiltonianPy.Basics import foptrep as FOPTREP
...
class Test_foptrep(TestCase):
    def setUp(self):
        ...
        self.config=IDFConfig(priority=DEFAULT_FERMIONIC_PRIORITY,map=lambda pid:Fermi(norbital=1,nspin=2,nnambu=2),pids=self.lattice.pids)
